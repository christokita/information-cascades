...
Focusing on information cascades, we explore how the information ecosystem (i.e., the collection of news outlets available to society) can reorganize social networks and result in "echo chambers," even when people do not know each other's political identities. A quick rundown of this project from the significance statement in our paper:
