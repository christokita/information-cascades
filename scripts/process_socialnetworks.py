...
sn_dir = '../data_sim/network_break/__suppl_sims/psmall/social_network_data/' #social network data
type_dir = '../data_sim/network_break/__suppl_sims/psmall/type_data/' #type data
tags = 'gamma' #file tags that designate runs from a particular simulation

# For output
outpath = '../data_derived/network_break/__suppl_analysis/psmall/social_networks/'
filetags = 'psmall' #added info after 'n<number>_assortativity
if len(filetags) > 0:
    filetags = '_' + filetags
