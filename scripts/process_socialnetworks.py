...
sn_dir = '../data_sim/network_break/__suppl-sim/adjust-tie-function/social_network_data/' #social network data
type_dir = '../data_sim/network_break/__suppl-sim/adjust-tie-function/type_data/' #type data
