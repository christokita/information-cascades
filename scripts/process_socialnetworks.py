...
sn_dir = '../data_sim/network_break/__suppl_sims/p0_longsim/social_network_data/' #social network data
...
filetags = 'p0_10^6steps' #added info after 'n<number>_assortativity
if len(filetags) > 0:
    filetags = '_' + filetags
