########################################
#
# PLOT: Fitness trial data with adjust_ties function instead of separate break_tie and make_tie functions
#
########################################
...
####################
# Read in data
cascade_data <- read.csv(casc_path, header = TRUE)
...
####################
behav_data <- read.csv(behav_path, header = TRUE)
