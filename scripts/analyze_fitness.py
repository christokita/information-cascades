...
fit_dir = '../data_sim/network_break/__suppl-sim/complete-network/fitness_data/' 
thresh_dir = '../data_sim/network_break/__suppl-sim/complete-network/thresh_data/'
...
filetags = 'complete' #added info after 'n<number>_fitness_<filetag>_
